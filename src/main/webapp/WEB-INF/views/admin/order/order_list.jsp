                          ...
                          <tbody>
                            ...
                            <c:forEach items="${order_list}" var="orderVO">
                              <tr>
                                ...
                                <td><button type="button" class="btn btn-info btn_order_detail"
                                    data-ord_code="${orderVO.ord_code}">주문상세</button></td>
                              </tr>
                            </c:forEach>
                          </tbody>
                        </table>
        ...
        <script>
          $(document).ready(function () {
            ...
            $(".btn_pro_del").on("click", function () {
              ...
              // <a class="move pro_name" href="#" data-bno="${orderVO.pro_num}">${orderVO.pro_name}</a>
